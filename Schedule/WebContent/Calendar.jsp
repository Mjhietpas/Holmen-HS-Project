<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="classes.*,java.util.*,java.text.*"
...
if(session.getAttribute("userType") == "admin"){
	homeButton = "<FORM action=\"Admin.jsp\">"+
			"<input type=\"submit\" value=\"Home\">"+
			"</FORM><br>";	
}

else if(session.getAttribute("userType") == "volunteer"){
	homeButton = "<FORM action=\"Volunteer.jsp\">"+
			"<input type=\"submit\" value=\"Home\">"+
			"</FORM><br>";	
}

else if(session.getAttribute("userType") == "student"){
	homeButton = "<FORM action=\"Student.jsp\">"+
			"<input type=\"submit\" value=\"Home\">"+
			"</FORM><br>";	
}

out.println(homeButton);

String newEventButton = "<FORM action=\"NewEvent.jsp\">"+
						"<input type=\"submit\" value=\"New Event\">"+
						"</FORM><br>";
						
if((String)session.getAttribute("userType") == "admin" || (String)session.getAttribute("userType") == "volunteer")
...
<INPUT type="submit" id="<%=monthNum-1%>" name="monthScroll" value="Previous month">
</FORM>

<FORM action="Calendar.jsp">
<input type="hidden" name="id" value="<%=monthNum+1%>">
<INPUT type="submit" id="<%=monthNum+1 %>" name="monthScroll" value="Next month">
</FORM>
