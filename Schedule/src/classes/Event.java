...
public class Event {
	...
	public Event(String title, int month, int day, int year, String startTime, String endTime, String about, int UID){
		this.title = title;
		this.month = month;
		this.day = day;
		this.year = year;
	...
	public Event(String title, int month, int day, int year, String startTime, String endTime, String about, int ID, int UID){
		this.title = title;
		this.month = month;
		this.day = day;
		this.year = year;
	...
	public Event(String info){
		...
		UID = Integer.parseInt(info.substring(0, info.indexOf("|")));
		info = info.substring(info.indexOf("|")+1);
	...
	public String getString(){
		return(UID + "|" + year + "|" + month + "|" + day + "|" + title + "|" + startTime + "|" + endTime + "|" + about);
	}
